...
[Current_VIP_Customer_Flag] [bit] NULL,
[NewOrChangedCustomer] [bit] NOT NULL,
[DateRegistered] [date] NULL CONSTRAINT [VIP_Customer_Dim_DateRegistered_DF] DEFAULT ('1900-01-01')
) ON [PRIMARY]
GO
