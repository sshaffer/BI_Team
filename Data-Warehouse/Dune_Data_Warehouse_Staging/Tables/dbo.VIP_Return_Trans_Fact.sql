...
[Discount_Value] [money] NOT NULL CONSTRAINT [VIP_Return_Trans_Fact_Discount_Val_DF] DEFAULT ((0)),
[VAT_Value] [money] NOT NULL CONSTRAINT [VIP_Return_Trans_Fact_VAT_Val_DF] DEFAULT ((0)),
