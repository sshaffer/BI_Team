...
CREATE PROCEDURE [dbo].[Merge_VIP_Return_Trans_Fact]
	@Source VARCHAR(MAX),
	@Log_ID BIGINT,
	@Cache BIT,
	@Process BIT
...
INSERT INTO @return
EXEC dbo.Log_Start @Source, 'Merge_VIP_Return_Trans_Fact', @Cache, @Process;
...
MERGE INTO dbo.VIP_Return_Trans_Fact target
USING Dune_Data_Warehouse_Staging..VIP_Return_Trans_Fact source
...
WHEN MATCHED THEN
    UPDATE SET
              ...
              ,Return_Price_Curr = source.Return_Price_Curr
              ,FP_Return_Price = source.FP_Return_Price
              ,FP_Return_Price_Curr = source.FP_Return_Price_Curr
              ,MD_Return_Price = source.MD_Return_Price
              ,MD_Return_Price_Curr = source.MD_Return_Price_Curr
              ...
              ,Gross_Return_Price_Home = source.Gross_Return_Price_Home
              ,Gross_Return_Price_Curr = source.Gross_Return_Price_Curr
...
WHEN NOT MATCHED THEN
    INSERT
           ...
           ,Return_Price_Curr
           ,FP_Return_Price
           ,FP_Return_Price_Curr
           ,MD_Return_Price
           ,MD_Return_Price_Curr
           ,Discount_Value_Home
           ,Discount_Value_Curr
           ,Cost_Price_Home
           ,Cost_Price_Curr
    ...
    VALUES (source.VIP_Customer_Dim_ID
           ...
           ,source.AI_TRN
           ,source.DC_DY_BSN
           ,source.Return_Price_Curr
           ,source.FP_Return_Price
           ,source.FP_Return_Price_Curr
           ,source.MD_Return_Price
           ,source.MD_Return_Price_Curr
           ...
           ,source.Gross_Return_Price_Home
           ,source.Gross_Return_Price_Curr
...
SET @Error_Response = 'An Error has occured in stored procedure dbo.Merge_VIP_Return_Trans_Fact: (%d)%s';
