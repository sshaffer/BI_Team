...
CREATE PROCEDURE [dbo].[Merge_Store_Web_Returns_Trans_Fact]
	@Source VARCHAR(MAX),
	@Log_ID BIGINT,
	@Cache BIT,
	@Process BIT
...
INSERT INTO @return
EXEC dbo.Log_Start @Source, 'Merge_Store_Web_Returns_Trans_Fact', @Cache, @Process;
...
MERGE INTO dbo.Store_Web_Returns_Trans_Fact target
USING (
	SELECT
	...
	FROM Dune_Data_Warehouse_Staging..Store_Web_Returns_Trans_Fact
	GROUP BY 
		Sale_Commission_Date_Dim_ID
	   ,Time_Dim_ID
	   ,Store_Dim_ID
...
SET @Error_Response = 'An Error has occured in stored procedure dbo.Merge_Store_Web_Returns_Trans_Fact: (%d)%s';
