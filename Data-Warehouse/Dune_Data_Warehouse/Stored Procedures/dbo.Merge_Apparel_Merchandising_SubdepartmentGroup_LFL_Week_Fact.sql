...
CREATE PROCEDURE [dbo].[Merge_Apparel_Merchandising_SubdepartmentGroup_LFL_Week_Fact]
    @Source VARCHAR(MAX)
   ,@Log_ID BIGINT
   ,@Cache BIT
   ,@Process BIT
...
INSERT  INTO @return
        EXEC dbo.Log_Start
            @Source
           ,'Merge_Apparel_Merchandising_SubdepartmentGroup_LFL_Week_Fact'
           ,@Cache
           ,@Process;
...
BEGIN TRY
    ...
    MERGE INTO dbo.Apparel_Merchandising_SubdepartmentGroup_LFL_Week_Fact target
    USING
        ( SELECT
            thisYear.Calendar_Week_Dim_Id AS Calendar_Week_Dim_Id
           ,thisYear.Store_Dim_ID
           ,thisYear.Subdepartment_Group_Dim_ID
          ...
          LEFT JOIN ( SELECT
            ...
            ON lastYear.Subdepartment_Group_Dim_ID = thisYear.Subdepartment_Group_Dim_ID
          ...
          LEFT JOIN ( SELECT
            ...
            ON nextYear.Subdepartment_Group_Dim_ID = thisYear.Subdepartment_Group_Dim_ID
    ...
    ON source.Calendar_Week_Dim_ID = target.Calendar_Week_Dim_ID
        ...
        AND source.Subdepartment_Group_Dim_ID = target.Subdepartment_Group_Dim_ID
    WHEN MATCHED THEN
        UPDATE SET
               LFL = source.LFL
	...
	USING (
          SELECT
           ...
           ,s.Store_Dim_ID
           ,d.Subdepartment_Group_Dim_ID
           ,LFL = 1
           ,LFL_LY = 1
          FROM
            dbo.BIS_Store_Dim s
          CROSS JOIN dbo.Subdepartment_Group_Dim d
...
BEGIN CATCH
    ...
    SET @Error_Response = 'An Error has occured in stored procedure dbo.Merge_Apparel_Merchandising_SubdepartmentGroup_LFL_Week_Fact: (%d)%s';
