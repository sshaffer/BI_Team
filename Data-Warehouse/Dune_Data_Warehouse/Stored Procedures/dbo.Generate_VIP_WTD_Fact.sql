...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Generate_VIP_WTD_Fact]
	@Source VARCHAR(100),
	@Log_ID BIGINT,
	@Cache BIT,
	@Process BIT
...
INSERT INTO @return
EXEC dbo.Log_Start @Source, 'Generate_VIP_WTD_Fact', @Cache, @Process;
...
/* Truncate Table */
TRUNCATE TABLE dbo.VIP_WTD_Fact;

INSERT INTO dbo.VIP_WTD_Fact (
   VIP_Customer_Dim_ID
   ,Item_Dim_ID
   ,Store_Dim_ID
   ,Sale_Price
...
SET @Error_Response = 'An Error has occured in stored procedure dbo.Generate_VIP_WTD_Fact: (%d)%s';
