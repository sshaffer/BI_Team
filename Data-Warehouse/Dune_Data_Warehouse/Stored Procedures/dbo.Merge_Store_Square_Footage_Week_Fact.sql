...
CREATE PROCEDURE [dbo].[Merge_Store_Square_Footage_Week_Fact]
	@Source VARCHAR(MAX),
	@Log_ID BIGINT,
	@Cache BIT,
	@Process BIT
...
INSERT INTO @return
EXEC dbo.Log_Start @Source, 'Merge_Store_Square_Footage_Week_Fact', @Cache, @Process;
...
USING Dune_Data_Warehouse_Staging..Store_Square_Footage_Week_Fact source
...
SET @Error_Response = 'An Error has occured in stored procedure dbo.Merge_Store_Square_Footage_Week_Fact: (%d)%s';
