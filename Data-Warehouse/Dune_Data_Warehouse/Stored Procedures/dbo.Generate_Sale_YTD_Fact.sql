...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[Generate_Sale_YTD_Fact]
	@Source VARCHAR(100),
	@Log_ID BIGINT,
	@Cache BIT,
	@Process BIT
...
INSERT INTO @return
EXEC dbo.Log_Start @Source, 'Generate_Sale_YTD_Fact', @Cache, @Process;
...
/* Truncate Table */
TRUNCATE TABLE dbo.Sale_YTD_Fact;

INSERT INTO dbo.Sale_YTD_Fact (
	Item_Dim_ID
	,Store_Dim_ID
	,Channel_Dim_ID
	,Currency_Dim_ID
...
SET @Error_Response = 'An Error has occured in stored procedure dbo.Generate_Sale_YTD_Fact: (%d)%s';
