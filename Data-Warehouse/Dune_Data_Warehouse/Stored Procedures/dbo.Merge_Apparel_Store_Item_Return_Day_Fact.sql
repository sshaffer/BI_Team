...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[Merge_Apparel_Store_Item_Return_Day_Fact]
AS

MERGE INTO Apparel_Store_Item_Return_Day_Fact target
USING
    ( SELECT
        Store_Dim_ID
       ,Calendar_Dim_Id
       ...
       ,SUM(Actual_Return_Value_Curr) AS Actual_Return_Value_Curr
       ,SUM(Actual_Return_Value_FP_Curr) AS Actual_Return_Value_FP_Curr
       ,SUM(Actual_Return_Value_MD_Curr) AS Actual_Return_Value_MD_Curr
       ,SUM(Actual_Return_Value_AED) AS Actual_Return_Value_AED
       ,SUM(Actual_Return_Value_FP_AED) AS Actual_Return_Value_FP_AED
       ,SUM(Actual_Return_Value_MD_AED) AS Actual_Return_Value_MD_AED
       ,SUM(Actual_Return_Value_GBP) AS Actual_Return_Value_GBP
       ,SUM(Actual_Return_Value_FP_GBP) AS Actual_Return_Value_FP_GBP
       ,SUM(Actual_Return_Value_MD_GBP) AS Actual_Return_Value_MD_GBP
      ...
      FROM
        dbo.Apparel_Store_Item_Return_Trans_Fact
      GROUP BY
        Store_Dim_ID
       ,Calendar_Dim_Id
       ,Item_Dim_ID
...
WHEN MATCHED THEN
    UPDATE SET
              ...
              ,Actual_Return_Value_Curr = source.Actual_Return_Value_Curr
              ,Actual_Return_Value_FP_Curr = source.Actual_Return_Value_FP_Curr
              ,Actual_Return_Value_MD_Curr = source.Actual_Return_Value_MD_Curr
              ,Actual_Return_Value_AED = source.Actual_Return_Value_AED
              ,Actual_Return_Value_FP_AED = source.Actual_Return_Value_FP_AED
              ,Actual_Return_Value_MD_AED = source.Actual_Return_Value_MD_AED
              ,Actual_Return_Value_GBP = source.Actual_Return_Value_GBP
              ,Actual_Return_Value_FP_GBP = source.Actual_Return_Value_FP_GBP
              ,Actual_Return_Value_MD_GBP = source.Actual_Return_Value_MD_GBP
...
WHEN NOT MATCHED THEN
    INSERT
           ...
           ,FP_Qty
           ,MD_Qty
           ,Actual_Return_Value_Curr
           ,Actual_Return_Value_FP_Curr
           ,Actual_Return_Value_MD_Curr
           ,Actual_Return_Value_AED
           ,Actual_Return_Value_FP_AED
           ,Actual_Return_Value_MD_AED
           ,Actual_Return_Value_GBP
           ,Actual_Return_Value_FP_GBP
           ,Actual_Return_Value_MD_GBP
           ,Discount_Value_Curr
    ...
    VALUES (source.Store_Dim_ID
           ...
           ,source.FP_Qty
           ,source.MD_Qty
           ,source.Actual_Return_Value_Curr
           ,source.Actual_Return_Value_FP_Curr
           ,source.Actual_Return_Value_MD_Curr
           ,source.Actual_Return_Value_AED
           ,source.Actual_Return_Value_FP_AED
           ,source.Actual_Return_Value_MD_AED
           ,source.Actual_Return_Value_GBP
           ,source.Actual_Return_Value_FP_GBP
           ,source.Actual_Return_Value_MD_GBP
