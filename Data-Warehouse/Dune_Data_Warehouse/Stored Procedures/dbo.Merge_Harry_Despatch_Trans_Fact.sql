...
CREATE PROCEDURE [dbo].[Merge_Harry_Despatch_Trans_Fact]
	@Source VARCHAR(MAX),
	@Log_ID BIGINT,
	@Cache BIT,
	@Process BIT
...
INSERT INTO @return
EXEC dbo.Log_Start @Source, 'Merge_Harry_Despatch_Trans_Fact', @Cache, @Process;
...
MERGE INTO dbo.Harry_Despatch_Trans_Fact target
USING Dune_Data_Warehouse_Staging..Harry_Despatch_Trans_Fact source
...
SET @Error_Response = 'An Error has occured in stored procedure dbo.Merge_Harry_Despatch_Trans_Fact: (%d)%s';
