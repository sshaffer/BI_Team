...
SET ANSI_NULLS ON
GO
CREATE PROC [dbo].[International_Generate_Net_Sales_WTD_Fact]
	@Source VARCHAR(MAX),
	@Log_ID BIGINT,
	@Cache BIT,
	@Process BIT
...
INSERT INTO @return
EXEC dbo.Log_Start @Source, 'International_Generate_Net_Sales_WTD_Fact', @Cache, @Process;
...
TRUNCATE TABLE International_Net_Sales_WTD_Fact;

INSERT INTO dbo.International_Net_Sales_WTD_Fact (
...
SET @Error_Response = 'An Error has occured in stored procedure dbo.International_Generate_Net_Sales_WTD_Fact: (%d)%s';
