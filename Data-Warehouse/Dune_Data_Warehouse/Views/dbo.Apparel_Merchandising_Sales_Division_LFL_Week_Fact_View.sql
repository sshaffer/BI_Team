...
CREATE VIEW [dbo].[Apparel_Merchandising_Sales_Division_LFL_Week_Fact_View]
AS
...
SELECT
   ...
   ,CASE WHEN lfl.LFL_LY = 1 THEN f.Actual_Sales_Value_GBP ELSE 0 END AS Actual_Sales_Value_GBP_LY
...
JOIN dbo.Apparel_Merchandising_Division_LFL_Week_Fact lfl
    ON lfl.Store_Dim_ID = f.Store_Dim_ID
       AND lfl.Division_Dim_ID = i.Division_Dim_ID
