...
CREATE VIEW [dbo].[Apparel_Merchandising_Sales_Department_LFL_Week_Fact_View]
AS
...
SELECT
   ...
   ,CASE WHEN lfl.LFL_LY = 1 THEN f.Gross_Profit_Curr ELSE 0 END AS Gross_Profit_Cur_LFL_LY
