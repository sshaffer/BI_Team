...
[VAT_Value_Home] [money] NOT NULL CONSTRAINT [Store_Item_Return_Trans_VAT_Home_DF] DEFAULT ((0)),
[VAT_Value_Curr] [money] NOT NULL CONSTRAINT [Store_Item_Return_Trans_VAT_Curr_DF] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[Store_Item_Return_Trans_Fact] ADD CONSTRAINT [Store_Item_Return_Trans_Fact_Channel_Dim_FK] FOREIGN KEY ([Channel_Dim_ID]) REFERENCES [dbo].[Channel_Dim] ([Channel_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Return_Trans_Fact] ADD CONSTRAINT [Currency_Store_Item_Return_Trans] FOREIGN KEY ([Currency_Dim_ID]) REFERENCES [dbo].[Currency_Dim] ([Currency_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Return_Trans_Fact] ADD CONSTRAINT [Store_Item_Return_Trans_Fact_Item_Dim_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Return_Trans_Fact] ADD CONSTRAINT [Return_Reason_Store_Item_Return_Trans] FOREIGN KEY ([Return_Reason_Dim_ID]) REFERENCES [dbo].[Return_Reason_Dim] ([Return_Reason_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Return_Trans_Fact] ADD CONSTRAINT [Time_Store_Item_Return_Trans] FOREIGN KEY ([Time_Dim_ID]) REFERENCES [dbo].[Time_Dim] ([Time_Dim_ID])
GO
