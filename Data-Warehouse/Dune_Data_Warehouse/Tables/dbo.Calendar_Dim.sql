...
[Holiday_Description] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [Calendar_Dim_Holiday_Desc_DF] DEFAULT (''),
[Major_Event_Indicator] [bit] NOT NULL,
[Major_Event_Description] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [Calendar_Dim_Major_Event_Desc_DF] DEFAULT (''),
...
[Relative_Day] [int] NOT NULL CONSTRAINT [Calendar_Dim_Reltive_Day_DF] DEFAULT ((0)),
...
[Standard_Period] [char] (6) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [Calendar_Dim_Standard_Period_DF] DEFAULT (''),
[W53_Period] [char] (6) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [Calendar_Dim_W53_Period_DF] DEFAULT ('')
) ON [PRIMARY]
...
GO
CREATE NONCLUSTERED INDEX [Calendar_Dim_ID_Date_Fiscal_Year_Week_Period_Relative_Day_IX] ON [dbo].[Calendar_Dim] ([Calendar_Dim_Id], [Calendar_Date], [Fiscal_Year], [Fiscal_Week], [Fiscal_Period], [Relative_Day]) INCLUDE ([Fiscal_Week_Beginning_Date]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Calendar_Dim_Current_Date_Flag_IX] ON [dbo].[Calendar_Dim] ([Current_Date_Flag]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Calendar_Dim_Fiscal_Year_Week_Date_ID_IX] ON [dbo].[Calendar_Dim] ([Fiscal_Year], [Fiscal_Week], [Calendar_Date], [Calendar_Dim_Id]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Calendar_Dim_Relative_Day_INC_Fiscal_Beginning_Date_IX] ON [dbo].[Calendar_Dim] ([Relative_Day]) INCLUDE ([Fiscal_Week_Beginning_Date]) ON [PRIMARY]
GO
