CREATE TABLE [dbo].[VIP_Customer_Current_Dim]
(
...
[DateRegistered] [date] NOT NULL CONSTRAINT [VIP_Customer_Current_Dim_DateRegistered_DF] DEFAULT ('1900-01-01')
) ON [PRIMARY]
ALTER TABLE [dbo].[VIP_Customer_Current_Dim] ADD
CONSTRAINT [VIP_Customer_Current_Dim_Store_Dim_FK] FOREIGN KEY ([Registered_Store_Dim_ID]) REFERENCES [dbo].[Store_Dim] ([Store_Dim_ID])

GO
ALTER TABLE [dbo].[VIP_Customer_Current_Dim] ADD CONSTRAINT [VIP_Customer_Current_Dim_PK] PRIMARY KEY CLUSTERED  ([VIP_Customer_Dim_ID]) ON [PRIMARY]
GO
