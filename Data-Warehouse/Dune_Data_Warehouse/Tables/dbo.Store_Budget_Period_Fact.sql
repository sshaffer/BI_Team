...
ALTER TABLE [dbo].[Store_Budget_Period_Fact] ADD CONSTRAINT [Store_Budget_Period_Fact_Store_FK] FOREIGN KEY ([Store_Dim_ID]) REFERENCES [dbo].[Store_Dim] ([Store_Dim_ID])
GO
