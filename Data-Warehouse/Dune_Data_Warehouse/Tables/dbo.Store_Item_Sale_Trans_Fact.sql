...
GO
ALTER TABLE [dbo].[Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Store_Item_Sale_Trans_Fact_Channel_Dim_FK] FOREIGN KEY ([Channel_Dim_ID]) REFERENCES [dbo].[Channel_Dim] ([Channel_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Currency_Store_Item_Sale_Trans_FK] FOREIGN KEY ([Currency_Dim_ID]) REFERENCES [dbo].[Currency_Dim] ([Currency_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Store_Item_Sale_Trans_Fact_Item_Dim_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Time_Store_Item_Sale_Trans] FOREIGN KEY ([Sale_Time_Dim_ID]) REFERENCES [dbo].[Time_Dim] ([Time_Dim_ID])
GO
