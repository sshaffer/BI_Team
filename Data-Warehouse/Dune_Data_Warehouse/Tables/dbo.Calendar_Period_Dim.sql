...
[Current_Period_Flag] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [Calendar_Period_Dim_Current_Period_Flag_DF] DEFAULT ('F'),
...
GO
CREATE NONCLUSTERED INDEX [Calendar_Period_Dim_Current_Period_Flag_IX] ON [dbo].[Calendar_Period_Dim] ([Current_Period_Flag]) ON [PRIMARY]
GO
