...
GO
ALTER TABLE [dbo].[Supplier_Dim] ADD CONSTRAINT [Supplier_Dim_Country_Dim_Country_Code_FK] FOREIGN KEY ([Country_Dim_ID]) REFERENCES [dbo].[Country_Dim] ([Country_Dim_ID])
GO
