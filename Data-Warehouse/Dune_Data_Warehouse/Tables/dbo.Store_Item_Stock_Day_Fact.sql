...
[Stock_in_Hand_FP_Qty] [int] NOT NULL CONSTRAINT [Store_Item_Stock_Day_Fact_Stock_in_Hand_FP_Qty_DF] DEFAULT ((0)),
[Stock_in_Hand_MD_Qty] [int] NOT NULL CONSTRAINT [Store_Item_Stock_Day_Fact_Stock_in_Hand_MD_Qty_DF] DEFAULT ((0)),
[Stock_in_Transit_FP_Qty] [int] NOT NULL CONSTRAINT [Store_Item_Stock_Day_Fact_Stock_in_Transit_FP_Qty_DF] DEFAULT ((0)),
[Stock_in_Transit_MD_Qty] [int] NOT NULL CONSTRAINT [Store_Item_Stock_Day_Fact_Stock_in_Transit_MD_Qty_DF] DEFAULT ((0)),
[Stock_Net_in_Hand_FP_Qty] [int] NOT NULL CONSTRAINT [Store_Item_Stock_Day_Fact_Stock_Net_in_Hand_FP_Qty_DF] DEFAULT ((0)),
[Stock_Net_in_Hand_MD_Qty] [int] NOT NULL CONSTRAINT [Store_Item_Stock_Day_Fact_Stock_Net_in_Hand_MD_Qty_DF] DEFAULT ((0))
) ON [PRIMARY]
WITH (DATA_COMPRESSION = PAGE)
GO
ALTER TABLE [dbo].[Store_Item_Stock_Day_Fact] ADD CONSTRAINT [Store_Item_Stock_Day_Fact_PK] PRIMARY KEY CLUSTERED  ([Calendar_Dim_ID], [Item_Dim_ID], [Store_Dim_ID]) WITH (DATA_COMPRESSION = PAGE) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Store_Item_Stock_Day_Fact] WITH NOCHECK ADD CONSTRAINT [Store_Item_Stock_Day_Fact_Item_Dim_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
ALTER TABLE [dbo].[Store_Item_Stock_Day_Fact] WITH NOCHECK ADD CONSTRAINT [Store_Item_Stock_Day_Fact_Store_Dim_FK] FOREIGN KEY ([Store_Dim_ID]) REFERENCES [dbo].[Store_Dim] ([Store_Dim_ID])
GO
