...
[Store_Dim_ID] [int] NOT NULL CONSTRAINT [PO_Exp_Del_Changes_Store_DF] DEFAULT ((-2147483648))
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[PO_Expected_Delivery_Changes_Fact] ADD CONSTRAINT [PO_Expected_Delivery_Changes_Fact_Calendar_Day_Dim_FK] FOREIGN KEY ([Calendar_Dim_ID]) REFERENCES [dbo].[Calendar_Dim] ([Calendar_Dim_Id])
GO
ALTER TABLE [dbo].[PO_Expected_Delivery_Changes_Fact] ADD CONSTRAINT [Calendar_Day_Dim_PO_Expected_Del_Changes_Fact_Expected_Del_Date_Date_FK] FOREIGN KEY ([Expected_Delivery_Date_Dim_ID]) REFERENCES [dbo].[Calendar_Dim] ([Calendar_Dim_Id])
GO
ALTER TABLE [dbo].[PO_Expected_Delivery_Changes_Fact] ADD CONSTRAINT [PO_Expected_Delivery_Changes_Fact_Item_Dim_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
