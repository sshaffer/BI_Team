CREATE TABLE [dbo].[Customer_Current_Dim]
(
...
ALTER TABLE [dbo].[Customer_Current_Dim] ADD
CONSTRAINT [Customer_Current_Dim_Country_Dim_FK] FOREIGN KEY ([Country_Dim_ID]) REFERENCES [dbo].[Country_Dim] ([Country_Dim_ID])
ALTER TABLE [dbo].[Customer_Current_Dim] ADD
CONSTRAINT [Currency_Customer_Current_Dim] FOREIGN KEY ([Currency_Dim_ID]) REFERENCES [dbo].[Currency_Dim] ([Currency_Dim_ID])
ALTER TABLE [dbo].[Customer_Current_Dim] ADD
CONSTRAINT [Customer_Current_Dim_Customer_Type_Dim_FK] FOREIGN KEY ([Customer_Type_Dim_ID]) REFERENCES [dbo].[Customer_Type_Dim] ([Customer_Type_Dim_ID])



GO
ALTER TABLE [dbo].[Customer_Current_Dim] ADD CONSTRAINT [Customer_Current_Dim_PK] PRIMARY KEY CLUSTERED  ([Customer_Dim_ID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [Customer_Current_Dim_Customer_Number] ON [dbo].[Customer_Current_Dim] ([Customer_Number]) ON [PRIMARY]
GO

EXEC sp_addextendedproperty N'MS_Description', N'Customer title e.g. Mr, Mrs, Rev, Sir', 'SCHEMA', N'dbo', 'TABLE', N'Customer_Current_Dim', 'COLUMN', N'Customer_Title'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Opted In/Opted Out', 'SCHEMA', N'dbo', 'TABLE', N'Customer_Current_Dim', 'COLUMN', N'Email_Marketing_Preference'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Email Marketing Only', 'SCHEMA', N'dbo', 'TABLE', N'Customer_Current_Dim', 'COLUMN', N'Gender'
GO
