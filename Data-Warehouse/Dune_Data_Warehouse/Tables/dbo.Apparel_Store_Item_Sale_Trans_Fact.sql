CREATE TABLE [dbo].[Apparel_Store_Item_Sale_Trans_Fact]
(
...
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Apparel_Store_Item_Sale_Trans_Fact_PK] PRIMARY KEY CLUSTERED  ([Store_Dim_ID], [Calendar_Dim_Id], [Time_Dim_ID], [Item_Dim_ID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Apparel_Store_Item_Sale_Trans_Fact_Calendar_FK] FOREIGN KEY ([Calendar_Dim_Id]) REFERENCES [dbo].[Calendar_Dim] ([Calendar_Dim_Id])
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Apparel_Store_Item_Sale_Trans_Fact_Item_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Apparel_Store_Item_Sale_Trans_Fact_Store_FK] FOREIGN KEY ([Store_Dim_ID]) REFERENCES [dbo].[Store_Dim] ([Store_Dim_ID])
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Sale_Trans_Fact] ADD CONSTRAINT [Apparel_Store_Item_Sale_Trans_Fact_Time_FK] FOREIGN KEY ([Time_Dim_ID]) REFERENCES [dbo].[Time_Dim] ([Time_Dim_ID])
GO
