CREATE TABLE [dbo].[PO_History_Fact]
(
...
[Purchase_Order_Component_Qty] [int] NOT NULL,
...
[User_ID] [char] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [PO_Hist_Fact_User_ID_DF] DEFAULT (''),
[Supplier_Cost] [money] NOT NULL CONSTRAINT [PO_Hist_Fact_Supplier_Cost_DF] DEFAULT ((0))
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[PO_History_Fact] ADD CONSTRAINT [PO_History_Fact_Item_Dim_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
ALTER TABLE [dbo].[PO_History_Fact] ADD CONSTRAINT [PO_History_Fact_Store_Dim_FK] FOREIGN KEY ([Store_Dim_ID]) REFERENCES [dbo].[Store_Dim] ([Store_Dim_ID])
GO
