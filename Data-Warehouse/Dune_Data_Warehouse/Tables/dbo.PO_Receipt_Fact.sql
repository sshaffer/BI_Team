...
[PO_Receipt_Component_Qty] [int] NOT NULL CONSTRAINT [PO_Receipt_Fact_Comp_Qty_DF] DEFAULT ((0)),
...
GO
ALTER TABLE [dbo].[PO_Receipt_Fact] ADD CONSTRAINT [Calendar_Day_PO_Receipt_Receipt_Date] FOREIGN KEY ([Calendar_Dim_ID]) REFERENCES [dbo].[Calendar_Dim] ([Calendar_Dim_Id])
GO
ALTER TABLE [dbo].[PO_Receipt_Fact] ADD CONSTRAINT [PO_Receipt_Fact_Item_Dim_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
ALTER TABLE [dbo].[PO_Receipt_Fact] ADD CONSTRAINT [PO_Receipt_Fact_Store_Dim_FK] FOREIGN KEY ([Store_Dim_ID]) REFERENCES [dbo].[Store_Dim] ([Store_Dim_ID])
GO
