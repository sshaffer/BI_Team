CREATE TABLE [dbo].[Apparel_Store_Item_Net_Sale_Day_Fact]
(
...
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Net_Sale_Day_Fact] ADD CONSTRAINT [Apparel_Store_Item_Net_Sale_Day_Fact_PK] PRIMARY KEY CLUSTERED  ([Calendar_Dim_Id], [Store_Dim_ID], [Item_Dim_ID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Net_Sale_Day_Fact] ADD CONSTRAINT [Apparel_Store_Item_Net_Sale_Day_Fact_Calendar_FK] FOREIGN KEY ([Calendar_Dim_Id]) REFERENCES [dbo].[Calendar_Dim] ([Calendar_Dim_Id])
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Net_Sale_Day_Fact] ADD CONSTRAINT [Apparel_Store_Item_Net_Sale_Day_Fact_Item_FK] FOREIGN KEY ([Item_Dim_ID]) REFERENCES [dbo].[Item_Dim] ([Item_Dim_ID])
GO
ALTER TABLE [dbo].[Apparel_Store_Item_Net_Sale_Day_Fact] ADD CONSTRAINT [Apparel_Store_Item_Net_Sale_Day_Fact_Store_FK] FOREIGN KEY ([Store_Dim_ID]) REFERENCES [dbo].[Store_Dim] ([Store_Dim_ID])
GO
